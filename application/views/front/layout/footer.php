                 ...
                 <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                     <div class="footer-widget__column footer-widget__about">
                         ...
                         <p class="footer-widget__text">
                             SAAD stands for the advocacy and growth of social consciousness, which completely summarizes the organizations' purpose.
                         </p>
                     ...
                     <div class="footer-widget__column footer-widget__contact">
                         ...
                         <ul class="list-unstyled footer-widget__contact-list">
                             <li>
                                 ...
                                 <div class="text">
                                     <p>
                                         ...
                                         <a href="tel:+91-8082054301">+91-8082054301</a><br>
                                         <a href="tel:+91-9082973909">+91-9082973909</a>
                                     </p>
                                 </div>
                             </li>
                             <li>
                             ...
                             <li>
                                 ...
                                 <div class="text">
                                     <p><span>Visit Office</span>Head Office:- R.No 05,Building No:-11A, Sharad CHS Ltd,Kapus Kamgar Nagar, Kurla (East),Mumbai:-400024 </p>
                                 </div>
                             </li>
                         </ul>
                     </div>
                 ...
                 <div class="col-xl-12">
                     <div class="site-footer__bottom-inner">
                         ...
                         <div class="site-footer__bottom-copy-right">
                             <p>© Copyright 2021 by <a href="#">Crezvatic.com</a></p>
                         </div>
                     </div>
                 </div>
             </div>
 ...
 <div class="mobile-nav__wrapper">
     ...
     <div class="mobile-nav__content">
         ...
         <div class="logo-box">
             <a href="index.html" aria-label="logo image"><img src="assets/images/resources/logo-1.png" width="155" alt="image" /></a>
         </div>
         <!-- /.logo-box -->
