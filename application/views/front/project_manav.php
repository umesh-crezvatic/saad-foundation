...
<section class="page-header">
    ...
    <!-- /.page-header__bg -->
    <div class="container">
        <h2>Project- Manav Children Home</h2>
        <ul class="thm-breadcrumb list-unstyled">
            <li><a href="<?php echo base_url() ?>">Home</a></li>
            <li class="color-thm-gray">/</li>
            <li><span>Project- Manav Children Home Details</span></li>
        </ul>
    </div>
</section>
<!--Page Header End-->
                ...
                <div class="causes-details__left-bar">
                    <div class="causes-details__img">
                        <div class="causes-details__img-box">
                            <img src="<?php echo base_url() ?>assets/images/resources/causes-details-img.jpg" alt="">
                        ...
                        <div class="causes-details__progress">
                            ...
                            <div class="causes-details__goals">
                                <p><span>₹29,500</span> Raised</p>
                                <p><span>₹30,000</span> Goal</p>
                            </div>
                        </div>
                    </div>
                    <div class="causes-details__text-box">
                        <h3>Project- Manav Children Home</h3>
                        <p class="causes-details__text-1">
                            SAAD foundation is not for profit organization working for wellbeing of underprivileged children and women. SAAD started open shelter home for homeless children and deprived children in 2018 named is MANAV CHILDREN HOME. Manav Child Home is comprehensive care program. Various activities were carried out as part of this project with the beneficiaries' well-being in mind.
                            Age group- 6 to 15 years
                            Total Beneficiary- 25 Children
                        ...
                        <ul class="become-volunteer-page__list list-unstyled">
                            <li>
                                ...
                                <div class="text">
                                    <p>To re-integrate the drop-out children to the schools by networking with various institutes.</p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p>To support a child effectively through all their needs including hunger and hygiene, education and social needs.</p>
                                </div>
                            </li>
                            <li>
                                <div class="icon">
                                ...
                                <div class="text">
                                    <p>To provide after-care support in the form of workshops, counselling, medical care and other recreational activities.</p>
                                </div>
                            </li>
                        </ul>
                        <p class="causes-details__text-1"></p>
                        <h3>Services provide in Manav Children Home </h3>
                        <ul class="become-volunteer-page__list list-unstyled">
                            <li>
                                <div class="icon">
                                    <i class="fas fa-arrow-circle-right"></i>
                            ...
                            <li>
                                ...
                                <div class="text">
                                    <p>Coaching and extra curriculum activity</p>
                                </div>
                            </li>
                        </ul>
                    </div>
